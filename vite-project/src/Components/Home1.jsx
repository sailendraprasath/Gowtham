    ...
    <>
      <div className="bg-mybg">
        <div>
          ...
          <div className="w-[1200px] h-[1px] ml-[100px] mt-5 bg-my5"></div>
          <h1 className="font-font3 font-bold text-xl py-4 ml-[100px]">
            Top Rating Tutors
          </h1>
          <div>
            <div className="flex items-center px-5 py-10 ml-[60px]">
              {data2.map((item, index) => (
                <div key={index} className=" p-4 rounded-md ml-12 px-12  ">
        ...
        <div>
          <h1 className="font-font3 font-bold text-xl py-4 ml-[100px]">
            Copy Home Tutors Near You
          </h1>
          <div className="flex items-center gap-6 ml-[450px] mt-[-40px]">
            <h1 className="bg-my7 w-[90px] rounded-xl font-bold text-center ">
              Filter
            </h1>
            <h1 className="bg-my7 w-[90px] rounded-xl font-bold text-center ">
              Rating
